...
class EntityDamageEventReflect(private val event: EntityDamageEvent) {
    val modifiers get() = field("modifiers") as MutableMap<DamageModifier, Double>
    val modifierFunctions get() = field("modifierFunctions") as MutableMap<DamageModifier, (Double) -> Double>
    val originals get() = field("originals") as MutableMap<DamageModifier, Double>
